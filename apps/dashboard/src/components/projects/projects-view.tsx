...
/**
 * Projects list (M12 12.2a, read-only). A pure-render Server Component: it receives the
 * server-fetched rows and renders a linked table — no client interactivity, so no `"use
 * client"` boundary. Each row links to the per-project detail. (Create/rename is 12.2b.)
 */
